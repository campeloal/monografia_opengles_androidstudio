...
public class ShaderActivity extends Activity {
	...
	private void createButtons(int width, int height, Context context){
		...
		final Drawable draw_add = this.getResources().getDrawable(R.drawable.add);
		final Drawable draw_add_press = this.getResources().getDrawable(R.drawable.add_press);
		final Drawable draw_dec = this.getResources().getDrawable(R.drawable.dec);
		final Drawable draw_dec_press = this.getResources().getDrawable(R.drawable.dec_press);
		final Drawable draw_time = this.getResources().getDrawable(R.drawable.timer);
		final Drawable draw_time_press = this.getResources().getDrawable(R.drawable.timer_press);
        ...
        add.setWidth((int) (width*0.15));
        add.setHeight((int) (width*0.15));
		add.setBackground(draw_add);

		dec.setX((float) (width * 0.025));
		dec.setY((float) (height*0.2));
        dec.setWidth((int) (width*0.15));
        dec.setHeight((int) (width*0.15));
        dec.setBackground(draw_dec);
		time.setX((float) (width * 0.8));
		time.setY((float) (height*0.05));
        time.setWidth((int) (width*0.15));
        time.setHeight((int) (width*0.15));
