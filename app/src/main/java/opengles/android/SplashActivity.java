        ...
        Thread background = new Thread() 
		{
			public void run() 
			{
                try
                {
                	...
                	if ((moreObj != null) && (moreObj.equals("Load more obj - 50000/60000")))
                	{
                	...
                	else if((moreObj != null) && (moreObj.equals("Load more obj - 80000")))
                	{
                		objects.add( new Object3D(R.raw.hand_80000, context));
                		loadMoreObj = "Load more obj - 80000";
                	}
                	else if((moreObj != null) && (moreObj.equals("Load more obj - 100000")))
                	{
                ...
                {
                    Log.e("LOADING", "I got an error:", e);
                }
